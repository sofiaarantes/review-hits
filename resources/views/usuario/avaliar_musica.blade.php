              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{ route('avaliacoes.store', $musica->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="nota" class="form-label">Nota</label>
                            <input type="number" class="form-control" id="nota" name="nota" placeholder="Digite a nota da música de 1 a 5." value="{{ old('nota') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="comentario" class="form-label">Comentário</label>
                            <input type="text" class="form-control" id="comentario" name="comentario" placeholder="Digite sua opinião sobre a música" value="{{ old('comentario') }}">
                        </div>
                        <input type="hidden" name="usuario_id" value="{{ Auth::user()->id }}">
                        <input type="hidden" name="musica_id" value="{{ $musica->id }}">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('musicas.show', $musica->id) }}" class="btn btn-secondary me-2">Cancelar</a>
