                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('artistas.update', $artista->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nome_artista" name="nome_artista" placeholder="Digite o nome do artista" value="{{ old('nome_artista', $artista->nome_artista) }}" required>
                        </div>
