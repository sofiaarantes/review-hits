                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('artistas.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nome_artista" name="nome_artista" placeholder="Digite o nome do artista" value="{{ old('nome_artista') }}" required>
                        </div>

                        <div class="d-flex justify-content-end">
                            <a href="{{ route('artistas.index') }}" class="btn btn-secondary me-2">Cancelar</a>
