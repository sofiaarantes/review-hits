                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                          @foreach($generos as $genero)
                            <tr class="text-center">
                              ...
                              <td>{{ $genero->updated_at->format('d M, Y') }}</td>
                              <td>
                                <div class="d-flex justify-content-end gap-2">
                                  <a href="{{ route('generos.edit', $genero->id) }}" class="btn btn-warning btn-sm" style="background-color:#cd9ff8;">Editar</a>
                      ...
                      @else
                          <p class="text-center text-muted">Nenhum gênero cadastrado.</p>
                      @endif
                    </div>
                  </div>
                </div>
