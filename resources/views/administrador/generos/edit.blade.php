                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('generos.update', $genero->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nome_genero" name="nome_genero" placeholder="Digite o nome do gênero" value="{{ old('nome_genero', $genero->nome_genero) }}" required>
                        </div>
