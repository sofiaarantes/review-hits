                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('musicas.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Digite o título da música" value="{{ old('titulo') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="album" class="form-label">Nome do álbum ao qual a música pertence</label>
                            <input type="text" class="form-control" id="album" name="album" placeholder="Digite o nome do álbum da música" value="{{ old('album') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="ano_lancamento" class="form-label">Ano que música foi lançada</label>
                            <input type="number" class="form-control" id="ano_lancamento" name="ano_lancamento" placeholder="Digite o ano de lançamento música" value="{{ old('ano_lancamento') }}" required>
                        </div>
