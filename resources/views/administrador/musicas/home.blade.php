                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <h4 class="card-title">Músicas</h4>
                      <a href="{{ route('musicas.create') }}" class="btn btn-primary btn-sm">
                          Cadastrar Música
                      </a>
                    </div>
                    <div class="table-responsive">
                        ...
                        <tbody>
                          @foreach($musicas as $musica)
                            <tr class="text-center">
                              ...
                              <td>{{ $musica->created_at->format('d M, Y') }}</td>
                              <td>
                                <div class="d-flex justify-content-end gap-2">
                                  <a href="{{ route('musicas.edit', $musica->id) }}" class="btn btn-warning btn-sm" style="background-color:#cd9ff8;">Editar</a>
                      ...
                      @else
                          <p class="text-center text-muted">Nenhuma música cadastrada.</p>
                      @endif
                    </div>
                  </div>
                </div>
